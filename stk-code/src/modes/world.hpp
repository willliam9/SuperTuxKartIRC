...
public:
    ...
    // ------------------------------------------------------------------------
    virtual bool hasTeams() const                             { return false; }//AIIMPORTANT
    // ------------------------------------------------------------------------
    ...
    // ------------------------------------------------------------------------
    /** Usefull for 4 teams mode in online*/
    virtual std::tuple<uint32_t, uint32_t, uint32_t, uint32_t> getGameStartedProgressT() const
    {
